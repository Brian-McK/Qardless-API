        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndUserId1 = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Certificates_EndUsers_EndUserId1",
                        column: x => x.EndUserId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificates_EndUserId1",
                table: "Certificates",
                column: "EndUserId1");
